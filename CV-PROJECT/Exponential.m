...
for i = 1:n
    ...
    subplot(2,3,2); imshow(I_exponential);              title(['Noisy Exponential, Variance = ', num2str(variance(i))]);
    ...
    subplot(2,3,2); imhist(I_exponential);              title(['Noisy Exponential, Variance = ', num2str(variance(i))]);
    ...
    subplot(2,3,6); imhist(im_f_mean_exponential);      title('Mean Filter');    
